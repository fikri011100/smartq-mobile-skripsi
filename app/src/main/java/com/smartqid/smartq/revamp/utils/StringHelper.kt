...
object StringHelper {
    ...
    fun formatDateFull(value: String?): String? {
        return formatingDateFromString("dd/MM/yyyy HH:mm", " EEEE, dd MMMM yyyy", value)
    }

    fun formatDateHour(value: String?): String? {
        return formatingDateFromString("dd/MM/yyyy HH:mm", " HH:mm", value)
    }
    ...
    fun formatingDateFromString(
        ...
        var format = SimpleDateFormat(fromFormat, Locale("id", "ID"))
        try {
            val newDate = format.parse(stringDate)
            format = SimpleDateFormat(toFormat, Locale("id", "ID"))
